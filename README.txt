...
a persistence unit "contato4jPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "contato4j/pom.xml":
...
artifact ("contato4j.war") is already built. You can build
